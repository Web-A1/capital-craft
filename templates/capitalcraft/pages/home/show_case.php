...
$cases = [
    [
        ...
        "strategy" =>
            "Провести аудит -  выявить критичные проблемы, сформировать «единый портрет» бизнеса.  Реализовать контрактное финансирование (243-ФЗ), завершить действующие договоры лизинга, перевести технику на новое юр. лицо (SPV), привлечь банк для отсрочки платежей на 3 месяца",
        "result" =>
            "Новый график платежей снижен на 27%, владение техникой осуществляется в «чистой» структуре, компания сэкономила 9,4 млн ₽ за первый год, подготовлена основа для участия в гос закупках.",
    ],
    [
        "title" => "30 миллионов для IT компании",
        "business" => "IT компания, разработка програмного обеспечения",
        "task" =>
            "Привлечь 30 млн. руб. для доработки продукта и выхода на внешние рынки. Определить роли и формат взаимодействия между инвестором и собственниками.",
        "strategy" =>
            'За 2 недели создать карту юридической структуры, далее взаимодействовать через ЦФА-платформу (в обмен на квазидолю + защита). Собрать "карту боли" - определить где клиенту не доверяет банк, и где не верит инвестор.',
        "result" =>
            "Привлечено 26,5 млн руб. за 17 дней, продукт выходит на внешние рынки, компания осталась независимой, уставный капитал не размылся, стратегический инвестор подключён через форму опциона",
    ],
    [
        ...
        "strategy" =>
            "Создать SPV с чистыми активами и прогнозным cashflow, подготовить презентацию, offer, финмодель, инвест-мемо и one-pager, привлечь синдикат из 2 частных инвесторов и проектного финансирования.",
        "result" =>
            "Запустили линии через 45 дней после сделки, инвесторы получили фиксированный долгосрочный доход и участие в бизнесе. Кейс оформлен в виде продукта для повторной упаковки (тиражируемый формат).",
    ],
]; ?>
                        ...
                        <?php foreach ($cases as $case): ?>
                            <div class="show-case__card swiper-slide">
                                <div class="show-case__card-content">
                                    <div class="show-case__card-title"><?= htmlspecialchars(
                                        $case["title"],
                                        ENT_QUOTES,
                                        "UTF-8",
                                    ) ?></div>
                                    <div class="show-case__details">
                                        <div class="show-case__detail">
                                            ...
                                            <div class="show-case__detail-description"><?= htmlspecialchars(
                                                $case["business"],
                                                ENT_QUOTES,
                                                "UTF-8",
                                            ) ?></div>
