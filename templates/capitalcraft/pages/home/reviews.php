        ...
        <div class="reviews__slider-container">
            ...
            <div class="reviews__arrow reviews__arrow--next">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 101 60" class="arrow-svg">
                    ...
                    <path fill="#000" d="M30 31a1 1 0 1 1 0-2v2Zm70.707-1.707a1 1 0 0 1 0 1.414l-6.364 6.364a1 1 0 0 1-1.414-1.414L98.586 30l-5.657-5.657a1 1 0 1 1 1.414-1.414l6.364 6.364ZM30 30v-1h70v2H30v-1Z" class="arrow-path"/>
                </svg>
            </div>
        </div>
    </div>
