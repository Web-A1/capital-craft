  ...
  <div class="blog-list">
    <?php foreach ($this->items as $i => $item) : ?>
      <?php
        ...
        $excerpt= HTMLHelper::_('string.truncate', strip_tags($item->core_body ?? ''), 200);
      ?>
          ...
          <?php if ($intro) : ?>
            <figure class="blog-card__image">
              <a href="<?php echo $link; ?>">
                <img src="<?php echo htmlspecialchars($intro, ENT_QUOTES, 'UTF-8'); ?>" alt="<?php echo htmlspecialchars($alt, ENT_QUOTES, 'UTF-8'); ?>">
              </a>
            </figure>
          <?php endif; ?>
        </div>
