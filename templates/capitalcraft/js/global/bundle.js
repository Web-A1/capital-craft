  ...
  'templates/capitalcraft/js/vendor/headroom.min.js'(exports, module) {
    !(function (t2, n2) {
        ...
        return (function (t4) {
          ...
          ? (function (t4) {
              ...
              return {
                ...
                scrollY: function () {
                  return void 0 !== t4.pageYOffset
                    ? t4.pageYOffset
                    : (s3 || o3.parentNode || o3).scrollTop;
                },
              };
            })(t3)
      ...
      function n2(t3, s3, e2) {
        var n3,
          o3 = (function () {
            ...
            try {
              ...
              window.addEventListener('test', t4, t4),
                window.removeEventListener('test', t4, t4);
            } catch (t5) {
              n4 = false;
            }
            return n4;
          ...
          a2 = {};
        function c() {
          var t4 = Math.round(r2.scrollY()),
            n4 = r2.height(),
            o4 = r2.scrollHeight();
          (a2.scrollY = t4),
            (a2.lastScrollY = l2),
            (a2.direction = l2 < t4 ? 'down' : 'up'),
            (a2.distance = Math.abs(t4 - l2)),
            (a2.isOutOfBounds = t4 < 0 || o4 < t4 + n4),
            (a2.top = t4 <= s3.offset[a2.direction]),
            (a2.bottom = o4 <= t4 + n4),
            (a2.toleranceExceeded = a2.distance > s3.tolerance[a2.direction]),
            e2(a2),
            (l2 = t4),
            (i2 = false);
        }
        ...
        return (
          t3.addEventListener('scroll', h, u),
          c(),
          {
            destroy: function () {
      ...
      function s2(t3, n3) {
        (n3 = n3 || {}),
          Object.assign(this, s2.options, n3),
          (this.classes = Object.assign({}, s2.options.classes, n3.classes)),
          (this.elem = t3),
          (this.tolerance = o2(this.tolerance)),
          (this.offset = o2(this.offset)),
      ...
      return (
        (s2.prototype = {
          ...
          update: function (t3) {
            t3.isOutOfBounds ||
              (true !== this.frozen &&
                (t3.top ? this.top() : this.notTop(),
                t3.bottom ? this.bottom() : this.notBottom(),
                this.shouldUnpin(t3)
                  ? this.unpin()
                  : this.shouldPin(t3) && this.pin()));
          },
        }),
        (s2.options = {
...
var init_micromodal_es_min = __esm({
  'templates/capitalcraft/js/vendor/micromodal.es.min.js'() {
    l =
      ...
      (i = (function () {
        function o2(e2) {
          ...
          !(function (e3, t2) {
            ...
            (this.modal =
              'string' == typeof n2 ? document.getElementById(n2) : n2),
            (this.config = {
              debugMode: C,
              disableScroll: b,
              openTrigger: u,
        ...
        return (
          ...
          (a2 = [
            ...
            },
            {
              ...
              value: function (e2) {
                (this.modal =
                  'string' == typeof e2 ? document.getElementById(e2) : e2),
            ...
            },
            {
              ...
              value: function (e2) {
                (e2.target.hasAttribute(this.config.closeTrigger) ||
                  e2.target.parentNode.hasAttribute(
      ...
      (a = null),
      (r = function (e2) {
        if ('string' == typeof id ? !document.getElementById(e2) : !e2)
          return (
            console.warn(
