...
$wa->useScript('com_associations.admin-associations-default')->useScript('table.columns')->useScript('multiselect');
                ...
                <?php else: ?>
                    <table class="table" id="associationsList">
                        ...
                        <?php foreach ($this->items as $i => $item):
                            ...
                            $isCheckout = AssociationsHelper::isCheckoutItem(
                                $this->extensionName,
                                $this->typeName,
                                $item->id,
                            );
                            ...
                            <tr class="row<?php echo $i % 2; ?>">
                                ...
                                <th scope="row" class="has-context">
                                    <div class="break-word">
                                        ...
                                        <?php endif; ?>
                                        <?php if ($canEdit): ?>
                                            <a class="hasTooltip" href="<?php echo Route::_(
                                                $this->editUri . '&id=' . (int) $item->id,
