...
$wa->useScript('multiselect')->useScript('com_associations.admin-associations-modal');
...
<div class="container-popup">
    <form action="<?php echo Route::_(
        'index.php?option=com_associations&view=associations&layout=modal&tmpl=component&function=' .
            $function .
            '&' .
        ...
        <?php // load the pagination.
                ...
                <tr>
                    ...
                    <?php if (!empty($this->typeFields['menutype'])): ?>
                        <th scope="col" class="w-10">
                            <?php echo HTMLHelper::_(
                                'searchtools.sort',
                                'COM_ASSOCIATIONS_HEADING_MENUTYPE',
                                'menutype_title',
                                $listDirn,
                                $listOrder,
                            ); ?>
            ...
            <?php foreach ($this->items as $i => $item):
                ...
                $canCheckin =
                    $canManageCheckin ||
                    AssociationsHelper::canCheckinItem($this->extensionName, $this->typeName, $item->id);
                ...
                <tr class="row<?php echo $i % 2; ?>">
                    <?php if (!empty($this->typeSupports['state'])): ?>
                        <td class="text-center">
                            <span class="tbody-icon">
                                <span class="<?php echo $iconStates[
                    ...
                    <th scope="row" class="has-context">
                        ...
                        <?php elseif ($canEdit && $isCheckout): ?>
                            ...
                            <span title="<?php echo Text::sprintf(
                                'JFIELD_ALIAS_LABEL',
                    ...
                    <td>
                        <?php if (true || $item->association): ?>
                            <?php echo AssociationsHelper::getAssociationHtmlList(
                                $this->extensionName,
                                $this->typeName,
                                (int) $item->id,
                                $item->language,
        ...
        <input type="hidden" name="forcedItemType" value="<?php echo $app
            ->getInput()
            ->get('forcedItemType', '', 'string'); ?>">
        <input type="hidden" name="forcedLanguage" value="<?php echo $app
            ->getInput()
            ->get('forcedLanguage', '', 'cmd'); ?>">
