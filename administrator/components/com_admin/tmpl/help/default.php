...
<form action="<?php echo Route::_(
    'index.php?option=com_admin&amp;view=help',
); ?>" method="post" name="adminForm" id="adminForm" class="main-card">
        ...
        <div id="sidebar" class="col-md-3">
            ...
            <div class="sidebar-nav" id="help-index">
                <ul class="nav flex-column">
                    <li class="item"><?php echo HTMLHelper::_(
                        'link',
                        Help::createUrl('Start_Here'),
                        Text::_('COM_ADMIN_START_HERE'),
                        ['target' => 'helpFrame'],
                    ); ?></li>
                    <li class="item"><?php echo HTMLHelper::_(
                        'link',
                        'https://help.joomla.org/proxy?keyref=Help4.x:License',
                        Text::_('COM_ADMIN_LICENSE'),
                        ['target' => 'helpFrame'],
                    ); ?></li>
                    <li class="item"><?php echo HTMLHelper::_(
                        'link',
                        Help::createUrl('Glossary'),
                        Text::_('COM_ADMIN_GLOSSARY'),
                        ['target' => 'helpFrame'],
                    ); ?></li>
                    <li class="divider"></li>
