...
if ($saveOrder && !empty($this->items)) {
    $saveOrderingUrl =
        'index.php?option=com_categories&task=categories.saveOrderAjax&tmpl=component&' .
...
<form action="<?php echo Route::_(
    'index.php?option=com_categories&view=categories&extension=' . $this->state->get('filter.extension'),
            ...
            <div id="j-main-container" class="j-main-container">
                ...
                <?php if (empty($this->items)): ?>
                    <div class="alert alert-info">
                        <span class="icon-info-circle" aria-hidden="true"></span><span class="visually-hidden"><?php echo Text::_(
                            'INFO',
                        ); ?></span>
                ...
                <?php
                    ...
                    <table class="table" id="categoryList">
                            ...
                            <tr>
                                ...
                                <?php if (
                                    ...
                                    <th scope="col" class="w-10 text-center d-none d-md-table-cell">
                                        ...
                                        <span class="d-none d-lg-inline"><?php echo Text::_(
                                            'COM_CATEGORIES_HEADING_PUBLISHED',
                                        ); ?></span>
                                    </th>
                                <?php endif; ?>
                                <?php if (
                                    ...
                                    <th scope="col" class="w-10 text-center d-none d-md-table-cell">
                                        ...
                                        <span class="d-none d-lg-inline"><?php echo Text::_(
                                            'COM_CATEGORIES_HEADING_UNPUBLISHED',
                                        ); ?></span>
                                    </th>
                                <?php endif; ?>
                                <?php if (
                                    ...
                                    <th scope="col" class="w-10 text-center d-none d-md-table-cell">
                                        ...
                                        <span class="d-none d-lg-inline"><?php echo Text::_(
                                            'COM_CATEGORIES_HEADING_ARCHIVED',
                                        ); ?></span>
                                    </th>
                                <?php endif; ?>
                                <?php if (
                                    ...
                                    <th scope="col" class="w-10 text-center d-none d-md-table-cell">
                                        ...
                                        <span class="d-none d-lg-inline"><?php echo Text::_(
                                            'COM_CATEGORIES_HEADING_TRASHED',
                                        ); ?></span>
                                    </th>
                                <?php endif; ?>
                                ...
                                <?php if ($this->assoc): ?>
                                    <th scope="col" class="w-10 d-none d-md-table-cell">
                                        <?php echo HTMLHelper::_(
                                            'searchtools.sort',
                                            'COM_CATEGORIES_HEADING_ASSOCIATION',
                                            'association',
                                            $listDirn,
                                            $listOrder,
                                        ); ?>
                        ...
                        <tbody <?php if (
                            $saveOrder
                        ): ?> class="js-draggable" data-url="<?php echo $saveOrderingUrl; ?>" data-direction="<?php echo strtolower(
    $listDirn,
); ?>" data-nested="false" <?php endif; ?>>
                            <?php foreach ($this->items as $i => $item): ?>
                                ...
                                $canEditOwn =
                                    $user->authorise('core.edit.own', $extension . '.category.' . $item->id) &&
                                    $item->created_user_id == $userId;
                                $canChange =
                                    $user->authorise('core.edit.state', $extension . '.category.' . $item->id) &&
                                    $canCheckin;
                                ...
                                <tr class="row<?php echo $i %
                                    2; ?>" data-draggable-group="<?php echo $item->parent_id; ?>" data-item-id="<?php echo $item->id; ?>" data-parents="<?php echo $parentsStr; ?>" data-level="<?php echo $item->level; ?>">
                                    ...
                                    <th scope="row">
                                        <?php $prefix = LayoutHelper::render('joomla.html.treeprefix', [
                                            'level' => $item->level,
                                        ]); ?>
                                        <?php echo $prefix; ?>
    ...
    'JACTION_EDIT',
                                    ...
                                    <?php if (
                                        ...
                                        <td class="text-center btns d-none d-md-table-cell itemnumber">
                                            <a class="btn <?php echo $item->count_published > 0
                                                ? 'btn-success'
                                                : 'btn-secondary'; ?>" href="<?php echo Route::_(
    'index.php?option=' .
        $component .
        ($section ? '&view=' . $section : '') .
        '&filter[category_id]=' .
        (int) $item->id .
        '&filter[published]=1&filter[level]=1',
                                    ...
                                    <?php if (
                                        ...
                                        <td class="text-center btns d-none d-md-table-cell itemnumber">
                                            <a class="btn <?php echo $item->count_unpublished > 0
                                                ? 'btn-danger'
                                                : 'btn-secondary'; ?>" href="<?php echo Route::_(
    'index.php?option=' .
        $component .
        ...
        '&filter[category_id]=' .
        (int) $item->id .
        '&filter[published]=0&filter[level]=1',
                                    ...
                                    <?php if (
                                        ...
                                        <td class="text-center btns d-none d-md-table-cell itemnumber">
                                            <a class="btn <?php echo $item->count_archived > 0
                                                ? 'btn-info'
                                                : 'btn-secondary'; ?>" href="<?php echo Route::_(
    'index.php?option=' .
        $component .
        ...
        '&filter[category_id]=' .
        (int) $item->id .
        '&filter[published]=2&filter[level]=1',
                                    ...
                                    <?php if (
                                        ...
                                        <td class="text-center btns d-none d-md-table-cell itemnumber">
                                            <a class="btn <?php echo $item->count_trashed > 0
                                                ? 'btn-dark'
                                                : 'btn-secondary'; ?>" href="<?php echo Route::_(
    'index.php?option=' .
        $component .
