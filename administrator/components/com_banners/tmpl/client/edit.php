...
<form action="<?php echo Route::_(
...
); ?>" method="post" name="adminForm" id="client-form" aria-label="<?php echo Text::_(
    'COM_BANNERS_CLIENT_' . ((int) $this->item->id === 0 ? 'NEW' : 'EDIT'),
    true,
); ?>" class="form-validate">
    ...
    <div class="main-card">
        ...
        <?php echo HTMLHelper::_(
            ...
            'myTab',
            'general',
            empty($this->item->id) ? Text::_('COM_BANNERS_NEW_CLIENT') : Text::_('COM_BANNERS_EDIT_CLIENT'),
        ); ?>
        <div class="row">
            <div class="col-lg-9">
                <?php
