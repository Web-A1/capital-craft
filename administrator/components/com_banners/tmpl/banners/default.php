...
if ($saveOrder && !empty($this->items)) {
    $saveOrderingUrl =
        'index.php?option=com_banners&task=banners.saveOrderAjax&tmpl=component&' . Session::getFormToken() . '=1';
...
<form action="<?php echo Route::_(
    ...
    $listDirn,
                            ...
                            <?php foreach ($this->items as $i => $item):
                                ...
                                $item->cat_link = Route::_(
                                    'index.php?option=com_categories&extension=com_banners&task=edit&type=other&cid[]=' .
                                        $item->catid,
                                );
                                ...
                                $canChange =
                                    $user->authorise('core.edit.state', 'com_banners.category.' . $item->catid) &&
                                    $canCheckin;
                                ?>
                                        ...
                                        <div class="break-word">
                                            ...
                                            <?php if ($canEdit): ?>
                                                <a href="<?php echo Route::_(
                                                    'index.php?option=com_banners&task=banner.edit&id=' .
                                                        (int) $item->id,
    ...
    'JACTION_EDIT',
                                    ...
                                    <td class="small d-none d-md-table-cell">
                                        <?php echo Text::sprintf(
                                            ...
                                            $item->impmade,
                                            $item->imptotal ?: Text::_('COM_BANNERS_UNLIMITED'),
                                        ); ?>
                                    </td>
                                    <td class="small d-none d-md-table-cell">
                                        ...
                                        <?php echo sprintf(
                                            '%.2f%%',
                                            $item->impmade ? (100 * $item->clicks) / $item->impmade : 0,
                                        ); ?>
                                    </td>
                                    <?php if (Multilanguage::isEnabled()): ?>
                                        <td class="small d-none d-md-table-cell">
