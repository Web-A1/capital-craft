                            ...
                            <tr>
                                ...
                                <?php if (
                                    ...
                                    <th scope="col" class="w-10 text-center d-none d-md-table-cell">
                                        ...
                                        <span class="d-none d-lg-inline"><?php echo Text::_(
                                            'COM_BANNERS_COUNT_PUBLISHED_ITEMS',
                                        ); ?></span>
                                    </th>
                                <?php endif; ?>
                                <?php if (
                                    ...
                                    <th scope="col" class="w-10 text-center d-none d-md-table-cell">
                                        ...
                                        <span class="d-none d-lg-inline"><?php echo Text::_(
                                            'COM_BANNERS_COUNT_UNPUBLISHED_ITEMS',
                                        ); ?></span>
                                    </th>
                                <?php endif; ?>
                                <?php if (
                                ...
                                <?php if (
                                    ...
                                    <th scope="col" class="w-10 text-center d-none d-md-table-cell">
                                        ...
                                        <span class="d-none d-lg-inline"><?php echo Text::_(
                                            'COM_BANNERS_COUNT_TRASHED_ITEMS',
                                        ); ?></span>
                                    </th>
                                <?php endif; ?>
                                        ...
                                        <div>
                                            ...
                                            <?php if ($canEdit): ?>
                                                <a href="<?php echo Route::_(
                                                    'index.php?option=com_banners&task=client.edit&id=' .
                                                        (int) $item->id,
                                    ...
                                    <td class="small d-none d-md-table-cell">
                                        <?php if ($item->purchase_type < 0): ?>
                                            <?php echo Text::sprintf(
                                                'COM_BANNERS_DEFAULT',
                                                Text::_(
                                                    'COM_BANNERS_FIELD_VALUE_' .
                                                        $purchaseTypes[$params->get('purchase_type')],
                                                ),
                                            ); ?>
                                        <?php else: ?>
                                            <?php echo Text::_(
                                                'COM_BANNERS_FIELD_VALUE_' . $purchaseTypes[$item->purchase_type],
                                            ); ?>
                                        <?php endif; ?>
                                    </td>
