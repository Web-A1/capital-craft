...
<div id="backup-percentage" class="progress">
    <div id="progressbar-inner" class="progress-bar" style="width: <?= min(
        max(0, (int) $this->percent),
        100,
    ) ?>%"></div>
</div>
...
<form action="<?= Route::_(
    'index.php?option=com_akeebabackup&task=Remotefiles.dltoserver&tmpl=component',
