					...
					<table class="table" id="articleList">
						...
						<tr>
							...
							<th scope="col">
								<?= HTMLHelper::_(
            'searchtools.sort',
            'COM_AKEEBABACKUP_PROFILES_LABEL_DESCRIPTION',
            'description',
            $listDirn,
            $listOrder,
        ) ?>
						...
						<?php foreach ($this->items as $i => $item): ?>
							<tr class="row<?= $i % 2 ?>">
								...
								<td class="d-none d-md-table-cell">
									<a href="<?= Route::_(
             'index.php?option=com_akeebabackup&task=SwitchProfile&profileid=' .
                 $item->id .
                 '&returnurl=' .
                 base64_encode('index.php?option=com_akeebabackup&view=Configuration') .
                 '&' .
                 ...
                 '=1',
									...
									<a href="<?= Route::_(
             'index.php?option=com_akeebabackup&task=Profile.export&id=' .
                 (int) $item->id .
                 '&format=json&' .
                 Factory::getApplication()->getFormToken() .
                 '=1',
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-body p-5">
				<form action="<?= Route::_(
        'index.php?option=com_akeebabackup&task=Profiles.import',
    ) ?>" method="post" name="importForm" id="importForm"
