...
<form action="<?php echo Route::_(
    'index.php?option=com_akeebabackup&view=Profile&layout=edit&id=' . (int) $this->item->id,
); ?>"
      method="post" name="adminForm" id="profile-form"
      aria-label="<?php echo Text::_(
          'COM_AKEEBABACKUP_PROFILES_PAGETITLE_' . ((int) $this->item->id === 0 ? 'NEW' : 'EDIT'),
          true,
      ); ?>"
      class="form-validate">
	...
	<div>
		<div class="card">
            ...
            <?php // If we're working on the default profile (ID=1), hide the access level field. Since this is our fallback
