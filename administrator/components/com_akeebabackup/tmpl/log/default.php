...
<form name="adminForm" id="adminForm" method="post"
    ...
    <div class="row row-cols-lg-auto gap-1 align-items-center">
        ...
        JUri::base(),
    ) ?>index.php?option=com_akeebabackup&view=Log&task=download&tag=<?= $this->escape($this->tag) ?>">
			...
			<div class="col flex-shrink-1">
				<a class="btn btn-outline-success" href="<?= $this->escape(
        JUri::base(),
    ) ?>index.php?option=com_akeebabackup&view=Alice&log=<?= $this->escape(
    $this->tag,
) ?>&task=start&<?= \Joomla\CMS\Factory::getApplication()->getFormToken() ?>=1">
        ...
        <div class="alert alert-warning">
            <p>
                <?= Text::sprintf(
                    ...
                    number_format($this->logSize / (1024 * 1024), 2),
                ) ?>
            </p>
