...
class Joomlaskipfiles extends Base
{
    public function __construct()
    {
        ...
        $this->filter_data[$root] = [
            ...
            $this->treatDirectory(
                Platform::getInstance()->get_site_root() . '/administrator/components/com_akeeba/backup',
            ),
            $this->treatDirectory(
                Platform::getInstance()->get_site_root() . '/administrator/components/com_akeebabackup/backup',
            ),
