...
trait RunPluginsTrait
{
     ...
     * @since   2023.08.25
     */
    protected static function triggerPluginEventStatic(
        string $event,
        array $arguments,
        ?string $className = null,
        $dispatcherOrSource = null,
    ): array {
        ...
        if (empty($dispatcher)) {
            try {
                ...
                $dispatcherAware =
                    $dispatcherOrSource instanceof DispatcherAwareInterface
                        ? $dispatcherOrSource
     ...
     * @since   2023.08.25
     */
    protected function triggerPluginEvent(
        string $event,
        array $arguments,
        ?string $className = null,
        $dispatcherOrSource = null,
        ...
        if (
            $dispatcherOrSource instanceof DispatcherAwareInterface ||
            $dispatcherOrSource instanceof DispatcherInterface
        ) {
