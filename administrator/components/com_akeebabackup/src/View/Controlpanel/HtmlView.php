...
class HtmlView extends BaseHtmlView
{
    ...
    public function display($tpl = null)
    {
        ...
        try {
            ...
            $this->getModel('Usagestats')->collectStatistics();
        } catch (Throwable $e) {
        ...
        $upgradeModel->init();
        $this->canUpgradeFromAkeebaBackup8 =
            version_compare(JVERSION, '4.4.999999', 'lt') &&
            in_array(true, $upgradeModel->runCustomHandlerEvent('onNeedsMigration'), true);
    ...
    protected function addJSScriptOptions()
    {
        $this->getDocument()->addScriptOptions(
            'akeeba.System.notification.hasDesktopNotification',
        ...
        $this->getDocument()->addScriptOptions(
            'akeeba.ControlPanel.outputDirUnderSiteRoot',
            (bool) $this->isOutputDirectoryUnderSiteRoot,
        );
        $this->getDocument()->addScriptOptions(
            'akeeba.ControlPanel.hasSecurityFiles',
            (bool) $this->hasOutputDirectorySecurityFiles,
        );
    }
        ...
        foreach ($lines as $line) {
            ...
            switch ($type) {
                ...
                case '+':
                    $ret .=
                        "\t" .
                        '<li><span class="badge bg-success">Added</span> ' .
                ...
                case '-':
                    $ret .=
                        "\t" .
                        '<li><span class="badge bg-dark">Removed</span> ' .
                        htmlentities(trim(substr($line, 2))) .
                        "</li>\n";
                    break;
                ...
                case '^':
                    $ret .=
                        "\t" .
                        '<li><span class="badge bg-info">Changed</span> ' .
                        htmlentities(trim(substr($line, 2))) .
                        "</li>\n";
                    break;
                ...
                case '*':
                    $ret .=
                        "\t" .
                        '<li><span class="badge bg-danger">Security</span> ' .
                        htmlentities(trim(substr($line, 2))) .
                        "</li>\n";
                    break;
                ...
                case '!':
                    $ret .=
                        "\t" .
                        '<li><span class="badge bg-warning">Important</span> ' .
                        htmlentities(trim(substr($line, 2))) .
                        "</li>\n";
                    break;
                ...
                case '#':
                    $ret .=
                        "\t" .
                        '<li><span class="badge bg-primary">Fixed</span> ' .
                        htmlentities(trim(substr($line, 2))) .
                        "</li>\n";
                    break;
