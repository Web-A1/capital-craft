...
class HtmlView extends BaseHtmlView
{
    ...
    {
        $this->getDocument()->getWebAssetManager()->useScript('com_akeebabackup.filefilters');
        ...
        $this->getDocument()
            ->addScriptOptions(
                ...
                Route::_('index.php?option=com_akeebabackup&view=Filefilters&task=ajax', false),
            )
            ->addScriptOptions(
                'akeebabackup.Fsfilters.loadingGif',
                Uri::root() . 'media/com_akeebabackup/icons/loading.gif',
            );
    ...
    private function addToolbar(): void
    {
        ...
        $toolbar
            ...
            ->icon(
                'fa fa-' .
                    (\Joomla\CMS\Factory::getApplication()->getLanguage()->isRtl() ? 'arrow-right' : 'arrow-left'),
            )
        ...
        $toolbar->help(
            null,
            false,
            'https://www.akeeba.com/documentation/akeeba-backup-joomla/exclude-data-from-backup.html#files-and-directories-exclusion',
        );
    }
}
