...
class HtmlView extends BaseHtmlView
{
    ...
    {
        $this->getDocument()->getWebAssetManager()->useScript('com_akeebabackup.databasefilters');
        ...
        $this->getDocument()->addScriptOptions(
            ...
            Route::_('index.php?option=com_akeebabackup&view=Databasefilters&task=ajax', false),
        );
